...
describe User do
  before { @user = User.new(firstname: "Example", lastname: "Example", email: "user@example.com", businesscategory: "IT", password: "foobar", password_confirmation: "foobar") }
  ...
  it { should respond_to(:businesscategory) }
